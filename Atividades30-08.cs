...
public class Program
{
    public static void Main()
    {
        ...
        Console.WriteLine("Nome completo em maiúsculas: " + nomeMaiusculo);
        Console.WriteLine("Nome completo em minúsculas: " + nomeMinusculo);
        Console.WriteLine("Número de caracteres no nome completo: " + numeroCaracteres);
        Console.WriteLine("Ano de nascimento calculado: " + anoNascimento);
        Console.WriteLine("Você fará 100 anos em: " + (2023 + idadeCemAnos));
    }
}
